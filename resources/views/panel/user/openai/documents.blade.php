...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-2 items-end justify-between max-md:flex-col max-md:items-start max-md:gap-4">
                    ...
                    <div class="flex items-center flex-wrap !mt-5">
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <form id="filterForm" method="GET"
                                action="{{ route('dashboard.user.openai.documents.all') }}">
                ...
                <div class="col-auto">
                    <div class="btn-list">
                        @if ($currfolder == null)
                            <a @if (env('APP_STATUS') == 'Demo') onclick="return toastr.info('This feature is disabled in Demo version.')" @else data-bs-toggle="modal" data-bs-target="#creatFolderModal" @endif
    ...
    <div class="page-body pt-6">
        <div class="container-xl">
            @if ($filter != 'image')
                @if (view()->exists('panel.admin.custom.user.openai.filters.' . $filter))
                    @include('panel.admin.custom.user.openai.filters.' . $filter)
                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        @if (env('APP_STATUS') == 'Demo') onclick="return toastr.info('This feature is disabled in Demo version.')" @else onclick="renameFolder()" @endif>{{ __('Save changes') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        @if (env('APP_STATUS') == 'Demo') onclick="return toastr.info('This feature is disabled in Demo version.')" @else onclick="confirmDelete()" @endif>{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
