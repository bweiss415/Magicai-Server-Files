						...
						$.ajax( {
							...
							success: async function ( response_ ) {
								...
								if ( realtime.checked && guest_search_k != "" ) {
									...
									try {
										jsonContent = jsonContent.organic;
									} catch ( error ) { }
									resmessages = [
										{
											role: 'user',
											content:
												...
												'Instructions: Generate an introductory text about the provided web search results with a curated list of links and descriptions using only the <a target="_blank">, Must write links with using <a target="_blank">. Margin Top of <a> tag must be 5px. Start order as number. Must write link first and then write description. Dont mention anything about the prompt text.', // <ol>, and <li> HTML tags and dont use <br> before the <li>
										},
									];
								}
